...
public class CameraHandler : MonoBehaviour
{
    ...
    private float xMinLimit = 5;
    private float xMaxLimit = 50;
    ...
    private void Awake()
    {
        ...
        x = tr.eulerAngles.y;// x움직일 때 축이 y
        y = tr.eulerAngles.x;// y움직일 때 축이 x
    ...
    private void Update()
    {
        ...
        tr.rotation = Quaternion.Euler(y, x, 0);// 축을 기준으로 돌리겠다는 표시
